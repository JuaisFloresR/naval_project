    ...
    const sampleRows: RowPart[] = [
      {
        ...
        value8: 9.2 + Math.random() * 5,
        value9: 14.8 + Math.random() * 5,
        value10: 22.0 + Math.random() * 5,
        value11: 16.3 + Math.random() * 5,
      ...
      },
      {
        ...
        value8: 10.6 + Math.random() * 5,
        value9: 15.4 + Math.random() * 5,
        value10: 21.7 + Math.random() * 5,
        value11: 17.8 + Math.random() * 5,
